                ...
                Container(
                  ...
                  child: (widget.file.image_koli == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera1(context, widget.file);
                            });
                          },
                          child: Container(
                ...
                Container(
                  ...
                  child: (widget.file.image_jolo_pelak == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera2(context, widget.file);
                            });
                          },
                          child: Container(
                            height: ((height * .75) * .88) * .15,
                      ...
                      : _decidedImageView(widget.file.image_jolo_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_jolo_rast_pelak == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera3(
                      ...
                      : _decidedImageView(widget.file.image_jolo_rast_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_jolo_chap_pelak == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera4(
                      ...
                      : _decidedImageView(widget.file.image_jolo_chap_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_aghab_pelak == null)
                      ...
                      : _decidedImageView(widget.file.image_aghab_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_aghab_rast_pelak == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera6(
                      ...
                      : _decidedImageView(widget.file.image_aghab_rast_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_aghab_chap_pelak == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera7(
                      ...
                      : _decidedImageView(widget.file.image_aghab_chap_pelak),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_shasi_number == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                      ...
                      : _decidedImageView(widget.file.image_shasi_number),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_motor_number == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                      ...
                      : _decidedImageView(widget.file.image_motor_number),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_ayene_kamel == null)
                      ...
                      : _decidedImageView(widget.file.image_ayene_kamel),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_lavazem_janebi_fabrik == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera11(
                      ...
                      : _decidedImageView(widget.file.image_lavazem_janebi_fabrik),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_gheyre_fabrik_otagh == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera12(
                      ...
                      : _decidedImageView(widget.file.image_gheyre_fabrik_otagh),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_zapas == null)
                      ...
                      : _decidedImageView(widget.file.image_zapas),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_ring_lastic == null)
                      ...
                      : _decidedImageView(widget.file.image_ring_lastic),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: 1,
                          style: BorderStyle.solid)),
                  child: (widget.file.image_kilometr_airbag == null)
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                              _openCamera15(
                      ...
                      : _decidedImageView(widget.file.image_kilometr_airbag),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_options == null)
                      ...
                      : _decidedImageView(widget.file.image_options),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_shishe == null)
                      ...
                      : _decidedImageView(widget.file.image_shishe),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_cart == null)
                      ...
                      : _decidedImageView(widget.file.image_cart),
                ),
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: width * .07, vertical: height * .01),
                  ...
                  child: (widget.file.image_khesarat == null)
                      ...
                      : _decidedImageView(widget.file.image_khesarat),
                ),
              ],
            ),
          ),
